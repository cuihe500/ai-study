...
│
├── chapter-04/                 # 第四章：理解AI的"思考"——基础原理
│   ├── how-ai-learns.md       # AI是如何学习的（训练数据、模式识别）
│   ├── llm-basics.md          # 预训练与微调——AI是怎么变成"助手"的
│   ├── context-window.md      # 上下文窗口是什么
│   └── token-explained.md     # Token：AI的"词汇单位"
│
├── chapter-05/                 # 第五章：AI编程的方法论与设计模式
│   ├── vibe-coding.md         # Vibe Coding：与AI共舞的编程新范式
│   ├── test-driven-development.md  # TDD测试驱动开发：用测试为AI导航
│   ├── spec-driven-development.md  # SDD规范驱动开发：让规格成为唯一真相
│   └── choose-your-workflow.md     # 选择适合你的工作流：方法论组合实践
│
...
```mermaid
flowchart LR
    A[入门阶段<br/>1-3章] --> B[原理穿插<br/>第4章] --> M[方法论<br/>第5章] --> C[进阶阶段<br/>6-14章]
...
| 章节 | 标题 | 核心目标 | 与实践的联系 |
|------|------|----------|--------------|
| 第4章 | 理解AI的"思考"——基础原理 | 理解AI为何这样工作 | 理解为什么AI有时"失忆"、为什么有字数限制等 |

### 第三部分：方法论与设计模式（第5章）

在掌握原理之后，引入当代 AI 编程的主流工作流，让读者带着方法论进入实战。

| 章节 | 标题 | 核心目标 | 关键概念 |
|------|------|----------|----------|
| 第5章 | AI编程的方法论与设计模式 | 学会按场景选择 Vibe Coding / SDD / TDD | Vibe Coding、SDD、TDD、Spec Kit、红绿重构 |
...
| 概念 | 所在章节 | 内容定位 |
|------|----------|----------|
| 训练数据、模式识别 | 第4章 | AI如何学习 |
| 预训练与微调 | 第4章 | AI从"博学者"到"好助手"的训练策略 |
| 上下文窗口 | 第4章 | 理解AI的"记忆力" |
| Token | 第4章 | AI的"词汇单位" |
...
| 概念 | 所在章节 | 内容定位 |
|------|----------|----------|
| Vibe Coding | 第5章 | 与AI共舞的新范式，由 Karpathy 在 2025 年提出 |
| SDD（规范驱动开发） | 第5章 | 规格作为唯一真相，代码是规格的产物 |
| TDD（测试驱动开发） | 第5章 | 用测试为AI导航，红-绿-重构循环 |
| 工作流选择 | 第5章 | 按任务规模与风险选择 Vibe / SDD / TDD 组合 |
